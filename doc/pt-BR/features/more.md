...
- **Frontend**: React i18next com arquivos de localidade `en.json`, `zh.json`, `es.json`, `fr.json`, `de.json`, `pt-BR.json` e `pt-PT.json`.
- **Backend**: Arquivos de localidade JSON embarcados, analisados a partir do cabeçalho `Accept-Language`, incluindo fallbacks regionais para português.
