...
### CardDAV (Contactos para vCard 4.0)
...
Bonds usa o timestamp `UpdatedAt` (época Unix) como ETag para todos os recursos DAV. Clientes usam EEtiquetas para detectar alterações e sincronizar eficientemente.
