...
Vaults are isolated containers that hold contacts and their associated data. They provide data separation and access control for multi-user setups.
...
Vault managers can invite other users to join the vault through the [User Invitations](/features/more#user-invitations) system. Each invitation specifies a permission level.
